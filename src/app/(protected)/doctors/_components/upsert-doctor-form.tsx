...
const formSchema = z
  .object({
    ...
    appointmentPrice: z
      .number()
      .min(0, "Preço da consulta deve ser um valor positivo"),
...
const UpsertDoctorForm = ({ onSuccess }: UpsertDoctorFormProps) => {
  ...
  const upsertDoctorAction = useAction(upsertDoctor, {
    ...
    onError: () => {
      toast.error(`Ocorreu um erro ao tentar adicionar um médico`);
    },
  });
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Horário inicial de disponbilidade</FormLabel>
                <Select
                  onValueChange={field.onChange}
                  defaultValue={field.value}
                >
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Horário final de disponbilidade</FormLabel>
                <Select
                  onValueChange={field.onChange}
                  defaultValue={field.value}
                >
